...
# STEP 1: Start at the Retriever Agent
workflow.set_entry_point(RETRIEVE)

# STEP 2: After retrieval, the Planner Agent analyzes context and creates an outline
workflow.add_edge(RETRIEVE, PLAN_EPISODE)

# STEP 3: After planning, the Writer Agent generates a script following the outline
workflow.add_edge(PLAN_EPISODE, GENERATE_SCRIPT)
