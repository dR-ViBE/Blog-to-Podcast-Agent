...
Your job is to analyze source material and create a structured episode outline that a script writer will follow.
...
1. **Analyze the Source Material:**
   - Read the retrieved blog content carefully.
   - Identify the 3-5 most interesting, surprising, or useful ideas.
   - Ignore boilerplate, navigation text, or repeated information.
...
#   - context: The concatenated text of all retrieved blog chunks
#
# The query is included so the planner knows what ANGLE the user cares about.
# The same blog content might produce very different outlines for
# "AI Agents" vs "AI Safety" vs "Building AI Applications".
